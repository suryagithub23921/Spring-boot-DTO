...
app.kubernetes.io/part-of: {{ default "NOT_SET" .Values.aokMetadata.partOf }}
app.kubernetes.io/component: {{ default "NOT_SET" .Values.aokMetadata.component }}
aok-systems.de/costcenter: {{ default "NOT_SET" .Values.aokMetadata.costcenter }}
{{- end }}
